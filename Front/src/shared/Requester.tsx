...
class _Requester {
  ...
  async getOAuthURL(id: string, data?: any, callback?: Function): Promise<any> {
    if (callback) callback(await this.get(`/auth/${id}`, data));
    else return await this.get(`/auth/${id}`, data);
  }
  async loginOauth(id: string, data?: any, callback?: Function): Promise<any> {
    if (callback) callback(await this.post(`/auth/${id}`, data));
    else return await this.post(`/auth/${id}`, data);
  }
}
