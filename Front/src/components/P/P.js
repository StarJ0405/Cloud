  ...
  return (
    <p
      ...
      style={{
        ...
        minWidth,
        maxWidth,
        fontWeight: weight || fontWeight || (!className ? "inherit" : null),
        fontFamily: font || fontFamily,
        fontSize: fontSize,
        fontStyle: i ? "italic" : fontStyle ? fontStyle : "normal",
        textIndent: textIndent,
        color: color || (!className ? "inherit" : null),
        ...
        cursor: cursor ? "pointer" : !className ? "inherit" : null,
        ...
        position,
        textDecorationLine: textDecoration || textDecorationLine || null,
        top,
        right,
        bottom,
        left,
